    ...
    return switch (role) {
      YorksV1Role.projectEngineer || YorksV1Role.siteEngineer => [
        ...
        _YorksDestination(
          ...
          disabledMessage: YorksV1ShellStrings.selectedRequestRequired,
        ),
        _YorksDestination(
...
class _YorksNavigationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: Tooltip(
        message: disabled
            ? destination.disabledMessage?.secondary(language) ?? ''
            : destination.label.secondary(language),
        child: Material(
          ...
          child: Column(
            ...
            children: [
              Icon(
                selected ? destination.selectedIcon : destination.icon,
                size: 21,
                color: selected ? Colors.white : AppColors.blueContainerStrong,
              ),
              const SizedBox(height: 2),
              Text(
                destination.label.primary,
...
class _YorksDestination {
  ...
  final TranslatableString? disabledMessage;
}
