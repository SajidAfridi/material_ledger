...
PdfColor _statusColor(RequestStatus s) => switch (s) {
  ...
  RequestStatus.onHold => const PdfColor.fromInt(0xFFB45309), // amber
...
Future<Uint8List> buildRequestReceiptPdf(
  ...
  doc.addPage(
    pw.MultiPage(
      ...
      header: (context) =>
          context.pageNumber == 1 ? pw.SizedBox() : _continuationHeader(req),
      footer: _footer,
      build: (context) => [
    ...
    child: pw.Column(
      children: [
        ...
        pw.Row(
          ...
          children: [
            pw.Text(
              'Computer-generated by Yorks AC. & Ref. · $stamp',
