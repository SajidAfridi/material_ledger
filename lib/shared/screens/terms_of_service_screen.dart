    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'By accessing or using Yorks AC. & Ref., you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use the application.',
              style: AppTypography.bodySmall.copyWith(
                color: AppColors.primary,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Gap(AppSpacing.xl),
        Text(
          '© 2026 Yorks AC. & Ref. — All Rights Reserved',
          style: AppTypography.bodySmall.copyWith(
...
const _sections = [
  _TermsSectionData(
    ...
    paragraphs: [
      'Yorks AC. & Ref. grants you a limited, non-exclusive, non-transferable, revocable license to use the application solely for your internal operational work.',
  ...
  _TermsSectionData(
    ...
    paragraphs: [
      'You agree to use Yorks AC. & Ref. only for lawful internal project and operational purposes. The following uses are strictly prohibited:',
    ],
    bullets: [
  ...
  _TermsSectionData(
    ...
    paragraphs: [
      'You are solely responsible for the accuracy and integrity of all operational data entered into Yorks AC. & Ref. This includes material quantities, prices, project names and transaction records.',
      'Yorks AC. & Ref. provides tools to manage your data but does not verify the accuracy of the information you enter. Decisions made based on Yorks AC. & Ref. data are your sole responsibility.',
      'Regular data backups are your responsibility. Yorks AC. & Ref. is not liable for data loss resulting from device failure, uninstallation or other circumstances.',
    ],
  ),
  _TermsSectionData(
    ...
    paragraphs: [
      'Material requisitions created within Yorks AC. & Ref. are internal workflow tools. They do not constitute legally binding purchase orders unless explicitly printed, signed and processed through your organization\'s official procurement channels.',
      'Yorks AC. & Ref. is not responsible for procurement decisions, vendor negotiations or financial commitments made based on requisitions generated within the application.',
    ],
  ),
  _TermsSectionData(
    ...
    paragraphs: [
      'Yorks AC. & Ref. is provided "AS IS" without warranty of any kind, express or implied. We do not warrant that the application will be error-free, uninterrupted or free of security vulnerabilities.',
  ...
  _TermsSectionData(
    ...
    paragraphs: [
      'To the maximum extent permitted by applicable law, Yorks AC. & Ref. and its developers shall not be liable for any indirect, incidental, special, consequential or punitive damages arising from your use of the application.',
  ...
  _TermsSectionData(
    ...
    paragraphs: [
      ...
      'Your continued use of Yorks AC. & Ref. after changes have been posted constitutes your acceptance of the revised Terms. If you do not agree to the new Terms, you should discontinue use of the application.',
    ],
  ),
];
