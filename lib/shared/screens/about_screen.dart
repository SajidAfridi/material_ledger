    ...
    return LedgerCard(
      child: Column(
        ...
        children: [
          ...
          const _InfoRow(label: 'Developer', value: 'Yorks AC. & Ref. Team'),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        // ─── Copyright ────────────────────────────────────
        Text(
          '© 2026 Yorks AC. & Ref. — Controlled project workspace',
          style: AppTypography.bodySmall.copyWith(
