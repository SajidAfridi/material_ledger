...
| 32 | Project Engineer Approval | Approval | Future | Planned | Assigned/global PE or audited Admin only; no Procurement self-approval |
| 33 | Return to Procurement | Approval | Future | Planned | Required reason and preserved arrangement history |
| 34 | Dispatch Entry | Logistics | Future | Planned | Procurement/Admin only; server-capped approved outstanding quantity |
| 35 | Receipt Review | Logistics | Future | Planned | Received/Missing/Damaged and exact reconciliation retained |
| 36 | Receipt Exception | Logistics | Future | Planned | Good quantity and required exception evidence remain explicit |
| 37 | Delivery Order | Logistics | Future | Planned | Committed dispatch snapshot; do not replace it with receipt facts |
| 38 | New Material Return | Returns | Future | Planned | Server-derived eligible quantities only |
| 39 | Material Return Review | Returns | Future | Planned | Explicit submit; stock changes only after Procurement confirmation |
| 40 | Documents | Documents | Future | Planned | Authorized classification, links and immutable versions |
| 41 | Document Viewer | Documents | Future | Planned | One generated byte source for preview/download/share/print |
...
| 48 | Duct Sizer | Tools | Future | Planned | Adapt the existing retained production tool only |
| 49 | ESP Calculator | Tools | Future | Planned | Adapt the existing retained production tool only |
| 50 | Profile & Settings | System | Future | Planned | Expose only implemented account/preferences/sync controls |
| 51 | Offline & Conflict State | System | Future | Planned | Truthful local/server state and explicit reconciliation |
| 52 | Empty States | System | Future | Planned | One useful action only when the real route/action exists |
