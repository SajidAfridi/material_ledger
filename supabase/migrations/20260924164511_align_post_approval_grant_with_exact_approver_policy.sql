-- Restore the current exact-role decision policy after the earlier additive
-- candidate expansion. The live v1_can_decide_material_request excludes an
-- exact Site Engineer even with membership and a delegated capability. The
-- edit grant must never exceed that live approval authority. No data changes.
